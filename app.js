...
import inventarioRoutes from './src/routes/inventario.routes.js' // Importa las rutas de inventario
...
app.use('/api/inventario', inventarioRoutes) // Rutas para inventario
